...
-define(TRANSFORM_FUNCTIONS, [{{[binary_to_integer, integer_to_binary, float_to_binary], [1, 2]}, otpbp_erlang},
                              ...
                              {{erlang, [convert_time_unit, insert_element], 3}, otpbp_erlang},
                              ...
                              {{atomics, info, 1}, otpbp_atomics},
                              {{atomics, [get, new], 2}, otpbp_atomics},
                              {{atomics, [add, add_get, exchange, put, sub, sub_get], 3}, otpbp_atomics},
                              {{atomics, compare_exchange, 4}, otpbp_atomics},
                              ...
                              {{lib, [format_call, format_stacktrace], 4}, erl_error},
                              {{lib, [format_call, format_stacktrace], 5}, otpbp_lib},
                              {{lib, format_exception, 6}, erl_error},
                              {{lib, format_exception, 7}, otpbp_lib},
